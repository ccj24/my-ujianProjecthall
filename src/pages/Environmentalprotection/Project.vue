<template>
  <div>
    <div class="top">
      <img class="img" src="http://img.redocn.com/sheying/20181228/daxingzhuangji_9997103.jpg" />
      <div class="message">
        <div class="one">
        ...
        <div class="photo">
          <img
            class="photo-1"
            src="https://ss0.bdstatic.com/94oJfD_bAAcT8t7mm9GUKT-xh_/timg?image&quality=100&size=b4000_4000&sec=1563699260&di=746cade57d938027b6b70f2bf494351e&src=http://pic1.win4000.com/pic/d/d4/181b859948.jpg_195.jpg"
          />
          <div class="photo-2">
            <p class="photo-3">项目经理</p>
          </div>
          <div class="photo-4">
            <p style=" float:left;">工作系数</p>
            <p class="photo-5">44%</p>
          </div>
        </div>
      </div>
    </div>
...
.packet-1 {
  ...
  line-height: 0.43rem;
  color: #333333;
  border-left: 0.11rem solid #12b7f5;
  text-align: right;
  margin-left: 0.41rem;
}
.packet-2 {
